    ...
    <div className=''>
      ...
      <div className='flex flex-col md:flex-row w-[100%] mt-5'>
        <div className='w-full md:w-[20%] h-auto md:h-[80%] flex flex-col justify-between items-center'>
          <div
            className='w-[55%] h-[24%] flex justify-center bg-[#afd9d9] items-center text-black flex-col p-2 rounded-xl mb-3 cursor-pointer'
            onClick={() => {
          ...
          >
            ...
            <p className='text-center'>Text <br /> Enhancer</p>
          </div>
          <div
